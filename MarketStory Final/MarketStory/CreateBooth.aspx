<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateBooth.aspx.cs" Inherits="MarketStory.Market.CreateBooth" %>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%">
                                            <tr width="100%">
                                                <td width="50%">
                                                    <asp:Label ID="Label1" runat="server" Font-Names="Calibri" Text="Booth Name: "></asp:Label>
                                                </td>
                                                <td align="left">
